...
define('CACHE_DIR_NAME',		'/imgcache/');
/*
switch($_SERVER['HTTP_HOST'])
{
	default:
		define('IMAGES_ROOT',			"/home/tweetag/current-version/backend/var/urlimages");
		break;
	case 'localhost.twitterslideshow.com':
		define('IMAGES_ROOT',			"/Users/xdamman/tweetag_dvl/backend/var/urlimages");
		break;
}
*/
if($_SERVER['HTTP_HOST']=='staging.publitweet.com')
	define('IMAGES_ROOT','/home/publitweet/current-version/backend/var/urlimages');
else
	define('IMAGES_ROOT',dirname(__FILE__).'/../../backend/var/urlimages');
...
$docRoot	= preg_replace('/\/$/', '', IMAGES_ROOT);
...

{
	...
	echo "Error: the cache directory {CACHE_DIR} is not writable";
